@extends('layouts.app')
@section('breadcrumb', 'Tahapan Rekrutmen')
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-5 z-index-2">
                        <div
                            ...
                            <h6 class="text-white text-capitalize m-0">Tahapan Rekrutmen</h6>
                        </div>
                    </div>
                                        ...
                                        <tr class={{ $low->status == 0 ? 'table-secondary' : '' }}>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('tahapan.manage', $low->id) }}" class="btn bg-gradient-info btn-sm text-white">
                                                        Manage Tahapan
                                                    </a>
                                                </div>
                                            </td>
