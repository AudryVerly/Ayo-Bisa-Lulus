                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="Masukkan nama lengkap" value="{{ $unit->name }}" required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <textarea id="deskripsi" name="deskripsi" class="form-control shadow-sm border rounded-3 px-3 py-2" rows="4"
                                    placeholder="Masukkan deskripsi unit secara lengkap" required> {{ $unit->deskripsi }}</textarea>
                            </div>
                             <div class="form-group mb-2">
                                ...
                                <textarea id="lokasi" name="lokasi" class="form-control shadow-sm border rounded-3 px-3 py-2" rows="2"
                                    placeholder="Masukkan alamat unit secara lengkap" required>{{ $unit->lokasi }}</textarea>
                            </div>
                             <div class="form-group mb-2">
                                <label for="kontak" class="form-label fw-bold text-secondary">Kontak Unit</label>
                                <input type="text" id="kontak" name="kontak"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    placeholder="Masukkan Kontak Unit" value="{{ $unit->kontak }}" required>
                            </div>
                             <div class="form-group mb-2">
                                <label for="emailUnit" class="form-label fw-bold text-secondary">Email Unit</label>
                                <input type="text" id="emailUnit" name="emailUnit"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    placeholder="Email Unit secara lengkap" value= "{{ $unit->emailUnit }}" required>
                            </div>
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a href="{{ route('units.index') }}" class="btn bg-gradient-secondary text-white px-4">
