                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="judulLowongan" name="judulLowongan"
                                    ...
                                    placeholder="Masukkan judul lowongan" value="{{ $lowongan->judulLowongan }}" required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <textarea id="deskripsi" name="deskripsi" class="form-control shadow-sm border rounded-3 px-3 py-2" rows="4"
                                    placeholder="Masukkan deskripsi lowongan secara lengkap" required> {{ $lowongan->deskripsi }}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea id="kualifikasi" name="kualifikasi" class="form-control shadow-sm border rounded-3 px-3 py-2" rows="6"
                                    ...
                                    Mampu bekerja tim"
                                    required>{{ old('kualifikasi', trim($lowongan->kualifikasi)) }}</textarea>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="posisiLowongan" name="posisiLowongan"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    placeholder="Masukkan judul lowongan" value="{{ $lowongan->posisiLowongan }}" required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="durasiKerja" name="durasiKerja"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    placeholder="Masukkan judul lowongan" value="{{ $lowongan->durasiKerja }}" required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="date" id="awalPendaftaran" name="awalPendaftaran"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    value="{{ \Carbon\Carbon::parse($lowongan->awalPendaftaran)->format('Y-m-d') }}"
                                    required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="date" id="batasPendaftaran" name="batasPendaftaran"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    value="{{ \Carbon\Carbon::parse($lowongan->batasPendaftaran)->format('Y-m-d') }}"
                                    required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="date" id="mulaiKerja" name="mulaiKerja"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    value="{{ \Carbon\Carbon::parse($lowongan->mulaiKerja)->format('Y-m-d') }}" required>
                            </div>
                            <div class="form-group mb-2">
                                ...
                                <input type="date" id="akhirKerja" name="akhirKerja"
                                    class="form-control shadow-sm border rounded-3 px-3 py-2"
                                    value="{{ \Carbon\Carbon::parse($lowongan->akhirKerja)->format('Y-m-d') }}" required>
                            </div>
